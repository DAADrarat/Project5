        ...
        <form action="${pageContext.request.contextPath}/signUp.do" method="post">
            <table class="table table-bordered text-center align-middle w-100 mx-auto mt-4" style="max-width: 600px;">
                ...
                <tr>
                    ...
                    <td style="width: 70%;">
                        <input type="text" name="userName" placeholder="이름을 입력해주세요" class="form-control" required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" name="userPw" placeholder="PW를 입력해주세요" class="form-control" required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="certificate" placeholder="보유자격증을 입력해주세요" class="form-control">
                    </td>
                </tr>
